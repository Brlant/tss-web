      ...
      <div class="content-right min-gutter">
        ...
        <div class="hide-content show-content">
          <el-form ref="form" :rules="rules" :model="form"
            ...
            <el-form-item label="上传业务追溯" style="position: relative">
              ...
              <div class="waring-tag">
                <i class="el-icon-warning"></i> 请选择单个文件上传
              </div>
            </el-form-item>
            <el-form-item>
      ...
      onSubmit() {
        this.$refs['form'].validate((valid) => {
          ...
          if (!this.form.attachmentIdList.length) {
            return this.$notify.info({message: '请选择业务追溯文件'});
          }
          if (this.form.attachmentIdList.length > 1) {
            return this.$notify.info({message: '请选择单个业务追溯文件'});
          }
          this.doing = true;
          http.post('/code-biz/file', {fileId: this.form.attachmentIdList[0]}).then(res => {
