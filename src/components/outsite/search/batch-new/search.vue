        ...
        <el-row>
          <el-col :span="8">
            <oms-form-row :span="5" label="货品">
              <el-select :remote-method="filterPermPlatFormGoods" @change="goodsChange" @click.native.once="filterPermPlatFormGoods('')" clearable filterable
          ...
          <el-col :span="8">
            <oms-form-row :span="5" label="批号">
              <el-select :remoteMethod="queryGoodsNumberOut('searchCondition.goodsId', false)"
                         clearable filterable placeholder="请输入批号名称搜索批号"
