    ...
    <div class="content-part">
      <div class="content-right min-gutter">
        ...
        <el-form ref="form" :model="form" label-width="100px"
          ...
          <el-form-item label="租户" prop="orgIdList"
                        :rules="[{required: true, type: 'array', message: '请选择租户', trigger: 'change'}]">
            <el-select filterable placeholder="请输入名称搜索租户" multiple reserve-keyword remote :remote-method="queryDownAllFactory"
    ...
    methods: {
      onSubmit: function (formName) {
        this.$refs[formName].validate((valid) => {
          ...
          this.doing = true;
          lesseeWhiteList.save(list).then(() => {
            this.doing = false;
            this.$notify.success({
              duration: 2000,
              name: '成功',
