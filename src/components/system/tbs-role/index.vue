          ...
          <div :style="'height:'+bodyHeight" class="d-table-col-wrap">
            <h2 class="header">
                <span class="pull-right">
                   <perm label="codes-access-platfrom-permission-export">
                ...
                <div v-else>
                  <ul class="show-list">
                    <li :class="{'active':item.id===currentItem.id}" @click="showType(item)" class="list-item"
                      ...
                      <perm label="codes-access-role-delete">
